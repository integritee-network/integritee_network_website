...
export const PRODUCTS_DOCS_LINK =
  'https://docs.integritee.network/3-our-technology'
...
export const FULL_STACK_DEV =
  'https://jobs.smartrecruiters.com/IntegriteeAG/743999815448800-full-stack-developer'

export const RUST_CORE_DEV =
  'https://jobs.smartrecruiters.com/IntegriteeAG/743999815462880-rust-core-developer'

export const SENIOR_DEVOPS =
  'https://jobs.smartrecruiters.com/IntegriteeAG/743999815439156-senior-devops-engineer'

export const ALL_POSITION = 'https://careers.smartrecruiters.com/IntegriteeAG'

export const KRAKEN_LINK =
  'https://www.kraken.com/prices/integritee?quote=usd&interval=24h'
