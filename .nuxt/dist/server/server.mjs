import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, ref, markRaw, defineComponent, createElementBlock, provide, cloneVNode, h, resolveComponent, computed, mergeProps, withCtx, createTextVNode, useSSRContext, openBlock, createElementVNode, unref, watch, createVNode, Suspense, Fragment, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
import { $fetch as $fetch$1 } from "ofetch";
import { baseURL, publicAssetsURL } from "#internal/nuxt/paths";
import { createHooks } from "/home/brenzi/integritee/integritee_network_website/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "/home/brenzi/integritee/integritee_network_website/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1, appendHeader } from "/home/brenzi/integritee/integritee_network_website/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter as createRouter$1, RouterView } from "vue-router";
import { toRouteMatcher, createRouter } from "/home/brenzi/integritee/integritee_network_website/node_modules/radix3/dist/index.mjs";
import { defu } from "/home/brenzi/integritee/integritee_network_website/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "/home/brenzi/integritee/integritee_network_website/node_modules/ufo/dist/index.mjs";
import "/home/brenzi/integritee/integritee_network_website/node_modules/klona/dist/index.mjs";
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderSuspense, ssrRenderVNode } from "vue/server-renderer";
...
const _routes = [
  {
    name: "about",
    path: "/about",
    component: () => import("./_nuxt/about-njy7ePbB.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-Dy-mDs1H.js")
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import("./_nuxt/contacts-BDwNLPy8.js")
  },
  {
    name: "products",
    path: "/products",
    component: () => import("./_nuxt/products-BbNv40AF.js")
  },
  {
    name: "useCases",
    path: "/useCases",
    component: () => import("./_nuxt/useCases-cRyUaQtu.js")
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/index-Dx7_WzVl.js")
  },
  {
    name: "developers",
    path: "/developers",
    component: () => import("./_nuxt/developers-BDf_SwK9.js")
  },
  {
    name: "technology",
    path: "/technology",
    component: () => import("./_nuxt/technology-Do50E7vv.js")
  },
  {
    name: "teer-Token",
    path: "/teer-Token",
    component: () => import("./_nuxt/teer-Token-DGW7bhyT.js")
  },
  {
    name: "privacy-policy",
    path: "/privacy-policy",
    component: () => import("./_nuxt/privacy-policy-BkMyD-P6.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CdLByUG0.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DIBY0bd8.js"));
...
export {
  ALL_POSITION as A,
  ATTESTEER_DEMO_LINK as B,
  CHECK_TECH_LINK as C,
  DISCORD_LINK as D,
  ATTESTEER_DOCS_LINK as E,
  FULL_STACK_DEV as F,
  GITHUB_LINK as G,
  HOW_TO_SETUP_LINK as H,
  INCOGNITEE_LINK as I,
  ATTESTEER_GITHUB_LINK as J,
  DEVELOPMENT_DOCS as K,
  TECHNOLOGY_LINK as L,
  __nuxt_component_0$1 as M,
  OFF_CHAIN_WORKER_LINK as O,
  PRODUCTS_DOCS_LINK as P,
  RUST_CORE_DEV as R,
  SENIOR_DEVOPS as S,
  TELEGRAM_LINK as T,
  WRITE_LINK as W,
  ...
  TWITTER_LINK as e,
  Twitter as f,
  SIDECHAIN_SDK_LINK as g,
  TEERACLE_LINK as h,
  ATTESTEER_LINK as i,
  SECURE_TEE_INFRASTRUCTURE_LINK as j,
  DOCS_LINK as k,
  TEER_TOKEN_LINK as l,
  GOVERNANCE_LINK as m,
  READ_LINK as n,
  PLAY_LINK as o,
  DEPLOY_LINK as p,
  SDK_DEMO_LINK as q,
  SDK_DOCS_LINK as r,
  SDK_GITHUB_LINK as s,
  tryUseNuxtApp as t,
  WORKER_DEMO_LINK as u,
  WORKER_DOCS_LINK as v,
  WORKER_GITHUB_LINK as w,
  TEERACLE_DEMO_LINK as x,
  TEERACLE_DOCS_LINK as y,
  TEERACLE_GITHUB_LINK as z
};
